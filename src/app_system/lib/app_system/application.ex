defmodule AppSystem.Discovery do
  ...
  def get_apps_path() do
      ...
      {:win32,_} ->
      	"C:/Users/Fabi/Desktop/Betriebsystem/docker/TestAppsInstallDir"
      _ ->
      	"/root"
    end
  end
  ...
  def init(_opts) do
    ...
    Process.send_after(self(), :heartbeat,1000) #60 * 60 * 1000) # In 60 min
  end
              ...
              |>Enum.map(fn e->
                ...
                %{:beam_name => (Path.basename e),
                  ...
                  :path => String.to_charlist(e)
  					...
  					:nothing -> []#IO.puts "NO NEED TO UPDATE/INSTALL "<>to_string dep_name
					end
				end )
